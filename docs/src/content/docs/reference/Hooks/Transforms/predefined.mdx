...
[lib/common/transforms.js](https://github.com/style-dictionary/style-dictionary/blob/main/lib/common/transforms.js)
:::
...
Scales the number and adds 'f' to the end.
...
When using DTCG color object definition for the color property, it will auto-convert it to a CSS compatible string if available in the color space in which it is defined.
