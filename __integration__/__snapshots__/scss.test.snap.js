...
$size-padding-xl: 1rem !default;
$color-background-primary: $color-core-neutral-0 !default;
$color-background-secondary: $color-core-neutral-100 !default;
$color-background-tertiary: $color-core-neutral-200 !default;
$color-background-danger: $color-core-red-0 !default;
$color-background-warning: $color-core-orange-0 !default;
$color-background-success: $color-core-green-0 !default;
$color-background-info: $color-core-blue-0 !default;
$color-border-primary: $color-core-neutral-300 !default;
$color-brand-primary: $color-core-aqua-700 !default;
$color-brand-secondary: $color-core-purple-700 !default;
$color-font-primary: $color-core-neutral-1100 !default;
$color-font-secondary: $color-core-neutral-900 !default;
$color-font-tertiary: $color-core-neutral-800 !default;
$color-font-danger: $color-core-red-1000 !default;
$color-font-warning: $color-core-orange-1000 !default;
$color-font-success: $color-core-green-1000 !default;
$color-background-disabled: $color-background-tertiary !default;
$color-font-interactive: $color-brand-primary !default;
$color-font-interactive-hover: $color-brand-primary !default;
$color-font-interactive-active: $color-brand-secondary !default;
$color-font-interactive-disabled: $color-font-tertiary !default;
